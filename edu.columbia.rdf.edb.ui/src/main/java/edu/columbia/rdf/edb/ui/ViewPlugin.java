...
public abstract class ViewPlugin implements Comparable<ViewPlugin> {
	...
	/**
	 * Should add sample sorters specific to the type of view this
	 * plugin represents. E.g. for microarray this could be the
	 * addition of a sorter to sort samples by array platform.
	 * 
	...
	/**
	 * Should add sample viewers specific to the type of view
	 * this plugin describes. Sample views are similar to
	 * sample sorters, but used for the very left folders
	 * pane in the main UI.
	 * 
	 * @param views
	 */
	...
	/**
	 * Should be overridden to add custom search functionality
	 * for features specific to this plugin, e.g. for
	 * microarrays, this could be to allow you to search by
	 * array plaform.
	 * 
	...
	/**
	 * Should return the name of the view. This is matched
	 * to a sample's expression type to determine how it should
	 * be displayed.
	 * 
	 * @return
	 */
